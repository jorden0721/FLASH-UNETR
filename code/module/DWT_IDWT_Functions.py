...
class DWTFunction_3D(Function):
    ...
    def forward(ctx, input,
        ...
        # input=input.unsqueeze(0)
        # print(input.shape,matrix_Low_0.shape, matrix_Low_1.shape, matrix_Low_2.shape,matrix_High_0.shape, matrix_High_1.shape, matrix_High_2.shape)

        L = torch.matmul(matrix_Low_0, input)
        H = torch.matmul(matrix_High_0, input)

        # print(L.shape,H.shape,torch.matmul(L, matrix_Low_1).shape)
